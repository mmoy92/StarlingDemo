...
:: Android packaging
set AND_CERT_NAME="Starling Android"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StarlingAndroid.p12
...
set IOS_PROVISION=cert\StarlingAndroid.mobileprovision
